...
class __TwigTemplate_366813f8863de14739744585af696669 extends Template
{
...
<article";
  ...
  <div class=\"cpg-article-teaser__content\" style=\"padding: 1.5rem 1.5rem 2rem; ";
    ...
    ";
        // line 30
        yield "    ";
        if ((($tmp = Twig\Extension\CoreExtension::trim($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_tags", [], "any", false, false, true, 30)))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 31
        ...
        <span style=\"color: #C41E3A; font-size: 0.7rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.08em;\">
          ";
            // line 34
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_tags", [], "any", false, false, true, 34))), "html", null, true);
            yield "
        </span>
      </div>
    ";
    ...
    ";
        ...
        if ((($tmp = ($context["is_featured"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            yield "font-size: 1.25rem; line-height: 1.3; margin-bottom: 0.5rem;";
        }
        yield "; font-family: 'Playfair Display', serif; font-weight: 700;\">
      <a href=\"";
        // line 41
    ...
    ";
        // line 47
        yield "    ";
        if ((($tmp = Twig\Extension\CoreExtension::trim($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "body", [], "any", false, false, true, 47)))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 48
            yield "      <div class=\"cpg-article-teaser__body\" style=\"font-family: 'Source Sans 3', sans-serif; ";
            if ((($tmp = ($context["is_featured"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
        ...
        ";
            // line 49
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::trim(Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "body", [], "any", false, false, true, 49)))), "html", null, true);
            yield "
      </div>
    ";
        }
    ...
    ";
        ...
        <a href=\"";
            // line 79
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["url"] ?? null), "html", null, true);
            yield "\" style=\"color: #C41E3A; font-weight: 700; font-size: 0.85rem; text-decoration: none; display: inline-block;\">Read more &rarr;</a>
        ";
            // line 80
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["node", "category_class", "attributes", "content", "category_icon", "url", "label", "display_submitted", "author_name", "date"]);        yield from [];
    }
    ...
    {
        return array (  224 => 85,  220 => 83,  214 => 81,  212 => 80,  208 => 79,  205 => 78,  202 => 77,  199 => 75,  190 => 68,  182 => 62,  177 => 60,  171 => 57,  167 => 55,  164 => 54,  161 => 52,  155 => 49,  146 => 48,  143 => 47,  136 => 42,  126 => 41,  117 => 40,  114 => 38,  107 => 34,  102 => 32,  99 => 31,  96 => 30,  89 => 27,  86 => 26,  80 => 23,  71 => 22,  68 => 21,  59 => 18,  56 => 17,  54 => 15,  53 => 14,  52 => 12,  49 => 11,  47 => 10,  44 => 8,);
    }
    ...
    public function checkSecurity()
    {
        ...
        static $filters = ["escape" => 18, "trim" => 21, "render" => 21, "default" => 32, "striptags" => 34, "upper" => 57, "first" => 57];
        static $functions = [];

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if'],
                ['escape', 'trim', 'render', 'default', 'striptags', 'upper', 'first'],
                [],
                $this->source
            );
