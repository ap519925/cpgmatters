...
($context["ptype"] ?? null) == "cpg_cta")) {
          ...
          ";
                    ...
                    // line 115
                    yield "          ";
                    if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["p"] ?? null), "field_p_link", [], "any", false, false, true, 115), 0, [], "any", false, false, true, 115), "url", [], "any", false, false, true, 115)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 116
...
($context["ptype"] ?? null) == "cpg_quote")) {
          ...
          ";
                    // line 125
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["p"] ?? null), "field_p_body", [], "any", false, false, true, 125), "value", [], "any", false, false, true, 125));
                    yield "
          ";
                    // line 126
                    if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["p"] ?? null), "field_p_title", [], "any", false, false, true, 126), "value", [], "any", false, false, true, 126)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 127
                        yield "            <cite>— ";
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["p"] ?? null), "field_p_title", [], "any", false, false, true, 127), "value", [], "any", false, false, true, 127), "html", null, true);
                        yield "</cite>
          ";
                    }
                    // line 129
      ...
      ";
                    ...
                    // line 133
                    yield "        ";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (($_v0 = CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_cpg_paragraphs", [], "any", false, false, true, 133)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0[CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, true, 133)] ?? null) : CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_cpg_paragraphs", [], "any", false, false, true, 133), CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, true, 133), [], "array", false, false, true, 133)), "html", null, true);
                    yield "
      ";
                }
                // line 135
  ...
  ";
        // line 140
        yield "  ";
        if ((Twig\Extension\CoreExtension::trim($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "body", [], "any", false, false, true, 140))) &&  !Twig\Extension\CoreExtension::trim($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_cpg_paragraphs", [], "any", false, false, true, 140))))) {
            // line 141
            yield "    <div class=\"cpg-about__body-fallback\">
      ";
            // line 142
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "body", [], "any", false, false, true, 142), "html", null, true);
            yield "
    </div>
  ";
        }
...
";
    ...
    public function checkSecurity()
    {
        ...
        static $filters = ["escape" => 11, "trim" => 12, "render" => 12, "striptags" => 23, "raw" => 34, "upper" => 92, "first" => 92, "last" => 92, "split" => 92, "without" => 147];
        static $functions = [];
