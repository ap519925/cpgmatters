...
class __TwigTemplate_e982622264132551ecfe8c7d28a50e3f extends Template
{
...
($context["show_description_toggle"] ?? null) == "invisible")) ? ("visually-hidden") : (""))];
  ...
  ";
    ...
    ";
        // line 85
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 85) && ((($context["description_display"] ?? null) == "before") || (($context["description_display_toggle"] ?? null) == "before")))) {
            // line 86
            yield "      <div";
    ...
    ";
      ...
      ";
        ...
        // line 104
        yield "      ";
        if (((CoreExtension::getAttribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 104) && CoreExtension::inFilter(($context["description_display"] ?? null), ["after", "invisible"])) && (($context["description_display_toggle"] ?? null) != "before"))) {
            // line 105
            yield "        <div";
